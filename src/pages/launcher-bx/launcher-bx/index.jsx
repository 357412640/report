...
import {notification, Popover, Select, Table, Icon, Empty} from 'antd'
import {BtnTag, SvgIcon} from '_c'
import {MyLineChart} from '_c/echarts'
import exportExcel from '@/utils/exportExcel'
import {deepCopy} from '@/utils/deepcopy'
import {channelView, indChannelView} from '@/api/launcher-data'
import {getData} from '@/api/application'


const {Option} = Select
const list = [
  {key: 'over', name: 'item点击排名'},
  {key: 'only', name: 'item点击趋势'}
]
...
class launcherBx extends Component {
  constructor(props) {
    super(props)
    this.state = {
      formCustom: {},
      ...
      <div className="main-page-box channel-access">
        <header className="header-box">
          <div className="title-box">
            <span className="title">桌面数据</span>
        ...
        <section className="common-table-box">
          {currentTabkey !== 'over' && channelList.length && <div className="sel-box">
            选择频道&nbsp;&nbsp;
